      ...
      <div class="film-details__info">
        ...
        <table class="film-details__table">
          ...
          <tr class="film-details__row">
            ...
            <td class="film-details__cell">${getDateFormate(release.date, FORMAT_DATE.releaseDatePopup)}</td>
          </tr>
          <tr class="film-details__row">
            <td class="film-details__term">Duration</td>
            <td class="film-details__cell">${durationMovies(duration, FORMAT_DATE.durationMovies)}</td>
          </tr>
          <tr class="film-details__row">
